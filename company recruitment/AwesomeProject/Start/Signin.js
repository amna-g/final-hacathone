...
// const save_data = ( email, password) => {
//   if( !email || !password){
       ...
       < Image source={{uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTwQF9d1AqKn3cF--lxSU3IKRtNP-kgeijOwg&usqp=CAU  '}} 
        ...
        <Item>
          ...
          <TouchableOpacity onPress={save_data} >
            <Text  onPress={()=>props.navigation.navigate('Start')} style={{textAlign:'center',fontSize:45,backgroundColor:'orange',clor:'white',marginBottom:259}} > Signup</Text>
           </TouchableOpacity>
          </View>
